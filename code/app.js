document.addEventListener('DOMContentLoaded', () => {
    ...
     let currentSnake = [2,1,0] // the "snakes" head being 2 and 0 being the end 1 being the body
     let direction = 1
     let score = 0
     let speed = 0.9
     let intervalTime = 0
    ...
    // function deals with all the outcomes of the snake
...
        squares[currentSnake[0] + direction].classList.contains('snake') // if snake bites it self
        ) {
    ...
     function control(e) {
         squares[currentIndex].classList.remove('snake') // removing the snake from last position
         
    if(e.keyCode === 39) {
